...
function Home() {
        ...
        <div id="carouselSabara" className="carousel slide mb-5" data-bs-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src="./src/assets/banner1.jpg" className="d-block w-100" alt="Entrada do Hospital Sabará" style={{ height: '400px', objectFit: 'cover' }} />
            ...
            <div className="carousel-item">
              <img src="./src/assets/banner2.webp" className="d-block w-100" alt="Equipe médica do Hospital Sabará" style={{ height: '400px', objectFit: 'cover' }} />
              <div className="carousel-caption d-none d-md-block">
            ...
            <div className="carousel-item">
              <img src="./src/assets/banner3.jpg" className="d-block w-100" alt="Ambiente acolhedor do Hospital Sabará" style={{ height: '400px', objectFit: 'cover' }} />
              <div className="carousel-caption d-none d-md-block">
  ...
  <div className="row row-cols-1 row-cols-md-4 g-4 justify-content-center">
    ...
    <article className="col-md-3">
      ...
      {/* Últimas Novidades */}
      <section className="container novidade mt-5">
        <h2 className="mb-4">Últimas Novidades</h2>
        <div className="card novidade-card">
          <a href="pagina-detalhes.html">
            <img src="./src/assets/projetoEdge.jpg" className="card-img-top" alt="Projeto Edge lançado pelo Hospital Sabará" />
          </a>
        </div>
      </section>
        ...
        <div className="row row-cols-1 row-cols-md-2 g-4">
          ...
          <div className="col">
            <div className="map-container h-100">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.5169674148906!2d-46.66183478840023!3d-23.549869578719285!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce5831b56f76c7%3A0xc1c434e6ae0e8fa8!2sSabar%C3%A1%20Hospital%20Infantil!5e0!3m2!1spt-BR!2sbr!4v1745594594254!5m2!1spt-BR!2sbr"
                width="100%"
                height="100%"
                style={{ border: '0' }}
                allowFullScreen=""
